module.exports = {
  ...
  exec(UnivBot, msg) {
    ...
    let rules = [
      ...
      "This is a homebrew server and as such is not the place for NSFW, politics, or anything else like that, please just treat each other respectfully and keep stuff like that in other servers.",
